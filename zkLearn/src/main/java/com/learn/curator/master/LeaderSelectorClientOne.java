 ...
 * comment:
 */
public class LeaderSelectorClientOne extends LeaderSelectorListenerAdapter implements Closeable {
    ...
    public LeaderSelectorClientOne(String processName) {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        LeaderSelectorClientOne leaderSelectorClient=new LeaderSelectorClientOne("ClientA");
