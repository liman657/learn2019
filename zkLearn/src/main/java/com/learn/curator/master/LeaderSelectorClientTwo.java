 ...
 * comment:
 */
public class LeaderSelectorClientTwo extends LeaderSelectorListenerAdapter implements Closeable {
    ...
    public LeaderSelectorClientTwo(String processName) {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        LeaderSelectorClientTwo leaderSelectorClient=new LeaderSelectorClientTwo("ClientB");
