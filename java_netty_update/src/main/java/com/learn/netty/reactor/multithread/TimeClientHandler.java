...
public class TimeClientHandler implements Runnable {
    ...
    private static AtomicInteger totalConnectCount = new AtomicInteger(0);
        ...
        if (key.isValid()) {
            ...
            if (key.isConnectable()) {
                if (socketChannel.finishConnect()) {
                    ...
                    log.info("client connect to server ,client time is {},client send count : {}",LocalDateTime.now().toString(),totalConnectCount.incrementAndGet());
            ...
            if (key.isReadable()) {
                ...
                if (readBytes > 0) {
                    ...
                    log.info("receive server message,Now is : {},count is {}",body,totalReadCount.incrementAndGet());
                    this.stop = true;
                }else if(readBytes < 0){
                    key.cancel();
                }
